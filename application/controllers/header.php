...
>
  <head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="<?php echo site_url('../assets/img/favicon/faviconico'); ?>" />
    ...
    <link rel="stylesheet" href="<?php echo site_url('../assets/vendor/fonts/boxicons.css'); ?>" />
    ...
    <link rel="stylesheet" href="<?php echo site_url('../assets/vendor/libs/apex-charts/apex-charts.css');  ?>" />
  ...
  <body>
      ...
      <div class="layout-container" style="min-height: 0vh;">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
                  <a href="<?php echo site_url('Candidat/FormulaireCV') ?>" class="menu-link">
            ...
            <li class="menu-item">
              <a href="<?php echo site_url('annonce_controller/afficherTous'); ?>" class="menu-link">
                ...
                <div data-i18n="Tables">Annonces</div>
              </a>
            </li>
          </ul>
        </aside>
    ...
    <script src="<?php echo site_url('../assets/vendor/libs/jquery/jquery.j'); ?>'"></script>
    ...
    <!-- Vendors JS -->
    <script src="<?php echo site_url('../assets/vendor/libs/apex-charts/apexcharts.js'); ?>"></script>

    <!-- Main JS -->
    <script src="<?php echo site_url('../assets/js/main.js'); ?>"></script>

    <!-- Page JS -->
    <script src="<?php echo site_url('../assets/js/dashboards-analytics.js'); ?>"></script>
