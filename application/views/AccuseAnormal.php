...
<div class="card" id="detail">
    ...
    <div class="demo-inline-spacing">
        <button type="button" class="btn btn-primary"><a href= <?php echo site_url("AccuseReception/versExplication?accuse=".$nbArticleAnormal[0]['idaccusereception']) ;?>>Expliquer </a></button>
    </div>
