...
<body>
    <form action="<?php echo site_url("BonReception/insertionBonReception"); ?>" method="post" >
        <input type="hidden" value="1" name="nombreArticle" id="inputHidden">
        <div class="mb-3 row">
            <label for="html5-date-input" class="col-md-2 col-form-label">Date de reception</label>
                <div class="col-md-10">
                    <input class="form-control" type="date"  id="html5-date-input" name="dateReception" />
                </div>
        </div>
        <div class="mb-3 row">
            <label for="html5-date-input" class="col-md-2 col-form-label">Numero de Bon de commande</label>
                <div class="col-md-10">
                    <input class="form-control" type="text"  id="html5-date-input" name="idBon" />
                </div>
        </div>
